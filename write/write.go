...
// Definindo a estrutura WeatherStation
type WeatherStation struct {
	city     string
	meanTemp float64
}

// Método de WeatherStation para medição da temperatura
func (w *WeatherStation) measurement() float64 {
	// Simulando uma distribuição gaussiana
	m := w.meanTemp + (rand.Float64()*20 - 10)
...
func Write(size int) {
	...
	for i := 0; i < size; i++ {
		...
		b.WriteString(fmt.Sprintf("%v;%v\n", randomStation.city, randomStation.measurement()))
	...
	fmt.Printf("%v written in %vs", size, duration.Seconds())
}
